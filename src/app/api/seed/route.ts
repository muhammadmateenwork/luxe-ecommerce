...
import { Product, Category, User, Review, Order, OrderItem, Coupon, Newsletter, CartItem, WishlistItem, RecentlyViewed, GiftCard, DeliveryMethod } from '@/lib/models';
  ...
  try {
    ...
    for (const pData of allProductData) {
      ...
      const product = await Product.create({
        ...
        isFlashSale: pData.isFlashSale || false, flashSaleEnds: (pData as any).flashSaleEnds || undefined,
      });
    ...
    let reviewCount = 0;
    const createdReviewPairs = new Set<string>();
